...
=======
class clsRecordproductos { //productos Class @117-36DBC647

//Variables @117-9E315808
...
//Class_Initialize Event @117-2C0E82A4
...
"FROM unidadesmedida {SQL_Where} {SQL_OrderBy}";
            ...
            $this->activo = new clsControl(ccsListBox, "activo", $CCSLocales->GetText("activo"), ccsInteger, "", CCGetRequestParam("activo", $Method, NULL), $this);
            $this->activo->DSType = dsListOfValues;
            $this->activo->Values = array(array("0", "Inactivo"), array("1", "activo"));
...
//Initialize Method @117-12D20661
    function Initialize()
    {
...
//CheckErrors Method @117-BBD78FA7
    function CheckErrors()
    {
        $errors = false;
...
} //End productos Class @117-FCB6E20C

class clsproductosDataSource extends clsDBConnection1 {  //productosDataSource Class @117-129A57C1

//DataSource Variables @117-5A2781C7
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @117-B82F6076
