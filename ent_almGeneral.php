<?php
//Include Common Files @1-C18A7612
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "ent_almGeneral.php");
...
class clsGrident_alm_general { //ent_alm_general class @6-A42D0D1A

//Variables @6-72C1F584
...
//Class_Initialize Event @6-873BE6AB
    function clsGrident_alm_general($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        ...
        $this->ErrorBlock = "Grid ent_alm_general";
        ...
        $this->SorterName = CCGetParam("ent_alm_generalOrder", "");
        $this->SorterDirection = CCGetParam("ent_alm_generalDir", "");
        ...
        $this->ent_alm_general_Insert = new clsControl(ccsLink, "ent_alm_general_Insert", "ent_alm_general_Insert", ccsText, "", CCGetRequestParam("ent_alm_general_Insert", ccsGet, NULL), $this);
        $this->ent_alm_general_Insert->Parameters = CCGetQueryString("QueryString", array("id", "ccsForm"));
        $this->ent_alm_general_Insert->Page = "ent_almGeneral.php";
...
//Show Method @6-FE29C9FA
    function Show()
    {
        ...
        $this->ent_alm_general_Insert->Show();
        $this->Header_id->Show();
...
//DataSource Variables @6-08FF16DC
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @6-C17DB008
...
class clsRecordent_alm_generalSearch { //ent_alm_generalSearch Class @38-AB7350DC
...
//Class_Initialize Event @38-0E50E640
...
//CheckErrors Method @38-5D2C1A24
...
//Operation Method @38-68D18582
    function Operation()
    {
        ...
        $Redirect = "ent_almGeneral.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "ent_almGeneral.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
} //End ent_alm_generalSearch Class @38-FCB6E20C

class clsRecordent_alm_general1 { //ent_alm_general1 Class @42-CC9652AF
...
//Class_Initialize Event @42-4AAFFB43
    function clsRecordent_alm_general1($RelativePath, & $Parent)
    {
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Record ent_alm_general1/Error";
        ...
        if($this->Visible)
        {
            ...
            $this->fechareg = new clsControl(ccsTextBox, "fechareg", $CCSLocales->GetText("fechareg"), ccsDate, array("ShortDate"), CCGetRequestParam("fechareg", $Method, NULL), $this);
        }
    }
//End Class_Initialize Event

//Initialize Method @42-2832F4DC
    function Initialize()
    {
...
//Validate Method @42-2B4B3F23
    function Validate()
    {
        ...
        $Validation = ($this->fechareg->Validate() && $Validation);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "OnValidate", $this);
        ...
        $Validation =  $Validation && ($this->fechareg->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @42-FD473E32
    function CheckErrors()
    {
        $errors = false;
        ...
        $errors = ($errors || $this->fechareg->Errors->Count());
        $errors = ($errors || $this->Errors->Count());
...
//InsertRow Method @42-774CD9B1
    function InsertRow()
    {
        ...
        $this->DataSource->fechareg->SetValue($this->fechareg->GetValue(true));
...
//Show Method @42-CD1E95E6
    function Show()
    {
        ...
        if($this->EditMode) {
            ...
            if($this->DataSource->Errors->Count() == 0 && $this->DataSource->next_record()) {
                ...
                if(!$this->FormSubmitted){
                    ...
                    $this->observaciones->SetValue($this->DataSource->observaciones->GetValue());
                    $this->activa->SetValue($this->DataSource->activa->GetValue());
                    $this->fechareg->SetValue($this->DataSource->fechareg->GetValue());
                }
            } else {
                $this->EditMode = false;
            }
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->fechareg->Errors->ToString());
            $Error = ComposeStrings($Error, $this->Errors->ToString());
...
} //End ent_alm_general1 Class @42-FCB6E20C

class clsent_alm_general1DataSource extends clsDBConnection1 {  //ent_alm_general1DataSource Class @42-E5CF3E7F

//DataSource Variables @42-280CD6B1
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @42-371CF363
    function clsent_alm_general1DataSource(& $Parent)
    {
        ...
        $this->fechareg = new clsField("fechareg", ccsDate, $this->DateFormat);
        ...
        $this->InsertFields["fechareg"] = array("Name" => "fechareg", "Value" => "", "DataType" => ccsDate, "OmitIfEmpty" => 1);
        $this->UpdateFields["fecha_proceso"] = array("Name" => "fecha_proceso", "Value" => "", "DataType" => ccsDate, "OmitIfEmpty" => 1);
        $this->UpdateFields["num_factura"] = array("Name" => "num_factura", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        ...
        $this->UpdateFields["fechareg"] = array("Name" => "fechareg", "Value" => "", "DataType" => ccsDate, "OmitIfEmpty" => 1);
    }
//End DataSourceClass_Initialize Event

//Prepare Method @42-35B33087
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//SetValues Method @42-452B3F41
    function SetValues()
    {
        ...
        $this->observaciones->SetDBValue($this->f("observaciones"));
        $this->activa->SetDBValue($this->f("activa"));
        $this->fechareg->SetDBValue(trim($this->f("fechareg")));
    }
//End SetValues Method

//Insert Method @42-2448CC91
    function Insert()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->InsertFields["fechareg"]["Value"] = $this->fechareg->GetDBValue(true);
...
//Update Method @42-A48EC922
    function Update()
    {
        ...
        $this->UpdateFields["num_factura"]["Value"] = $this->num_factura->GetDBValue(true);
        ...
        $this->UpdateFields["fechareg"]["Value"] = $this->fechareg->GetDBValue(true);
...
} //End ent_alm_general1DataSource Class @42-FCB6E20C

//Initialize Page @1-EBC56CF3
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ent_almGeneral.html";
$BlockToParse = "main";
...
//Include events file @1-CDB1BBB0
include_once("./ent_almGeneral_events.php");
...
$ent_alm_general = new clsGrident_alm_general("", $MainPage);
$ent_alm_generalSearch = new clsRecordent_alm_generalSearch("", $MainPage);
$ent_alm_general1 = new clsRecordent_alm_general1("", $MainPage);
...
//Execute Components @1-95EEF5B7
$MasterPage->Operations();
$ent_alm_general1->Operation();
$ent_alm_generalSearch->Operation();
//End Execute Components

//Go to destination page @1-DE65940B
if($Redirect)
{
