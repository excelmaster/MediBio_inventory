...
//Class_Initialize Event @53-29948E84
    function clsGridunidadesmedida($RelativePath, & $Parent)
    {
        ...
        $this->Alt_id = new clsControl(ccsLink, "Alt_id", "Alt_id", ccsInteger, "", CCGetRequestParam("Alt_id", ccsGet, NULL), $this);
        $this->Alt_id->Page = "unimed_mant.php";
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                else
                {
                    ...
                    $this->Alt_id->Parameters = CCGetQueryString("QueryString", array("ccsForm"));
                    $this->Alt_id->Parameters = CCAddParam($this->Alt_id->Parameters, "id", $this->DataSource->f("id"));
