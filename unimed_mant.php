...
//Class_Initialize Event @6-E78C3CA8
    function clsGridunidadesmedida($RelativePath, & $Parent)
    {
        ...
        $this->Detail->Page = "unimed_mant.php";
        ...
        $this->Alt_Detail->Page = "unimed_mant.php";
        ...
        $this->unidadesmedida_Insert->Page = "unimed_mant.php";
...
class clsRecordunidadesmedida1 { //unidadesmedida1 Class @49-9684EBB1
...
//Class_Initialize Event @49-5F675568
...
//CheckErrors Method @49-9A019823
    function CheckErrors()
    {
        $errors = false;
...
} //End unidadesmedida1 Class @49-FCB6E20C

class clsunidadesmedida1DataSource extends clsDBConnection1 {  //unidadesmedida1DataSource Class @49-6E62A872

//DataSource Variables @49-E4FFEAC5
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @49-15679B67
...
} //End unidadesmedida1DataSource Class @49-FCB6E20C
