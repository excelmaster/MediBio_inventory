...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='tabla de clientes de MediBiologica';

-- Volcando datos para la tabla u392883857_inven.clientes: ~1 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='listado de productos';

-- Volcando datos para la tabla u392883857_inven.productos: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla u392883857_inven.unidadesmedida: ~1 rows (aproximadamente)
