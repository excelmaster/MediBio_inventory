...
CREATE TABLE IF NOT EXISTS `unidadesmedida` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='unidades de medida';

-- Volcando datos para la tabla u392883857_inven.unidadesmedida: ~2 rows (aproximadamente)
