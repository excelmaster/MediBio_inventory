...
-- Volcando datos para la tabla u392883857_inven.ent_alm_general: ~3 rows (aproximadamente)
...
INSERT INTO `ent_alm_general` (`id`, `fecha_proceso`, `num_factura`, `observaciones`, `activa`, `fechareg`) VALUES
	(1, '0000-00-00 00:00:00', '8956', 'primera entrada almacen', NULL, NULL),
	(2, '0000-00-00 00:00:00', '967987979', 'ljljlj', 'si', NULL),
	(3, '0000-00-00 00:00:00', '8564616', 'farmacos s.a. pedido 345', 'Si', NULL);
...
INSERT INTO `main_redirection` (`id`, `grupo`, `name_sitio`, `link_sitio`, `img_sitio`, `page`, `rol`) VALUES
	(1, 1, 'administracion', 'admin.php', 'img/main_admin.jpg', NULL, NULL),
	(2, 1, 'Almacen General', 'almacen_main.php', 'img/almGeneral.jpg', NULL, NULL),
	(3, 2, 'Almacen General', 'almacen_main.php', 'img/almGeneral.jpg', NULL, NULL),
	(4, 3, 'Farmacia', 'farmacia.php', 'img/farmacia.gif', NULL, NULL),
	(5, 1, 'Farmacia', 'farmacia.php', 'img/farmacia.gif', NULL, NULL),
	(6, 2, 'Entrada de Almacen', 'ent_alm_general.php', 'img/entrada_alm.png', 'almacen_main', NULL),
	(7, 2, 'Salida de almacen', 'almacen_main.php', 'img/salida_alm.png', 'almacen_main', NULL),
	(8, 3, 'Entrada de Farmacia', 'Farmacia_main.php', '', 'farmacia_main', NULL),
	(9, 3, 'Salida de Farmacia', 'Farmacia_main.php', NULL, 'farmacia_main', NULL);
