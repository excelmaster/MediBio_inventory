<?php
class clsmasterpage { //masterpage class @1-F8B55459
...
//Class_Initialize Event @1-F9AF8F0E
...
//Initialize Method @1-C3F1D1A0
    function Initialize($Path = "")
    {
        ...
        // Create Components
        $this->contenido = new clsPanel("contenido", $this);
        $this->contenido->isContentPlaceholder = true;
        $this->pie = new clsPanel("pie", $this);
        $this->pie->isContentPlaceholder = true;
        $this->cabecera = new clsPanel("cabecera", $this);
        $this->cabecera->isContentPlaceholder = true;
        $this->BindEvents();
