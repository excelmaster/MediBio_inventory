<?php
//Include Common Files @1-6CA0929D
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "Clientes_mant_s_num_documento1_YahooAutocomplete1.php");
...
class clsGridclientes { //clientes class @2-9CC2092A
...
//Class_Initialize Event @2-1824F128
...
} //End clientes Class @2-FCB6E20C

class clsclientesDataSource extends clsDBConnection1 {  //clientesDataSource Class @2-E85581CD

//DataSource Variables @2-424EA40E
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-61BE333D
...
//Prepare Method @2-417C86EA
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "num_documento", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-3F500BD0
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM clientes";
        $this->SQL = "SELECT num_documento \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Clientes_mant_s_num_documento1_YahooAutocomplete1.html";
$BlockToParse = "main";
...
//Go to destination page @1-900A60EA
if($Redirect)
{
