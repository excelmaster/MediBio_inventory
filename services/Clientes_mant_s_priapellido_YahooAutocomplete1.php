<?php
//Include Common Files @1-FBBDF652
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "Clientes_mant_s_priapellido_YahooAutocomplete1.php");
...
//Class_Initialize Event @2-F09E8A11
...
//DataSource Variables @2-72FC2B99
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-8932536E
...
//Prepare Method @2-ECB9026F
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "priapellido", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-F38570FF
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM clientes";
        $this->SQL = "SELECT priapellido \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Clientes_mant_s_priapellido_YahooAutocomplete1.html";
$BlockToParse = "main";
