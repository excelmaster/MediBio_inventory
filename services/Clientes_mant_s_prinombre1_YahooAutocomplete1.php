<?php
//Include Common Files @1-BB509E45
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "Clientes_mant_s_prinombre1_YahooAutocomplete1.php");
...
//Class_Initialize Event @2-7B733E76
...
//DataSource Variables @2-680D8B19
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-E3120368
...
//Prepare Method @2-8AFF6E5C
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "prinombre", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-B9307334
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM clientes";
        $this->SQL = "SELECT prinombre \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "Clientes_mant_s_prinombre1_YahooAutocomplete1.html";
$BlockToParse = "main";
